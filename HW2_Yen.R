...
class(C1survey)
sapply(C1survey, class) #here, I could see whether the variable is renamed or not by telling whether they are labelled.
                        # In addition, I could also see the variable type.
...
C1survey$homecountry<-ifelse(C1survey$What.is.your.home.country.=='United States'|
                             ...
                             ifelse(C1survey$What.is.your.home.country.=="Ethiopia","Ethiopia",
                                    ifelse(C1survey$What.is.your.home.country.=="Taiwan","Taiwan","Unknown")))
...
>>>>>>> bd2b2abf7dc7c0035d1a4da8a4992e1167124eca
